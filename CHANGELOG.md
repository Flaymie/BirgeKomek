...
### ✨ Добавлено
- **Система черновиков для заявок:**
  - Пользователи теперь могут создавать и сохранять заявки как черновики, не публикуя их.
  - Реализован полноценный интерфейс для редактирования черновиков, включая изменение текста и управление вложениями.
  - Добавлена возможность удалять прикрепленные файлы в черновиках.
  - Черновик можно в любой момент опубликовать, сделав его видимым для всех.
- **Счетчик уведомлений:** Реализован счетчик непрочитанных уведомлений в реальном времени, который появляется на иконке-колокольчике в шапке сайта.
