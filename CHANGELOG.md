...
- **Критическая ошибка рендеринга**: Исправлена ошибка "Element type is invalid", возникавшая из-за некорректного экспорта компонента `StatusBadge`. Файл компонента был переписан для обеспечения стабильности.