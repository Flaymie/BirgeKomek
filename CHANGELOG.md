...
### Добавлено
- Функциональность создания запросов на помощь:
  - Кнопка "Создать запрос" на странице со списком запросов.
  - Страница с формой для создания нового запроса.
  - Валидация полей формы.
  - Интеграция с API для отправки запроса на сервер.
