...
- **Стабильность сокетов:** Исправлена критическая ошибка, приводившая к постоянному переподключению сокетов и, как следствие, потере событий (например, о создании новой заявки). Жизненный цикл сокета теперь строго привязан к ID пользователя.
