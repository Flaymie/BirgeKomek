...
### 🐞 Исправлено
- **Восстановлена работа выпадающего меню уведомлений:** Возвращено выпадающее меню на десктопе, которое было случайно удалено. На мобильных устройствах сохраняется переход на отдельную страницу. Счетчик убран.
- **Исправлена логика онлайн-статуса:** Статус "онлайн" теперь корректно обновляется в реальном времени благодаря "пингам" от клиента, что решает проблему с неактуальным временем последнего посещения.
