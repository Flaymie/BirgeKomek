    ...
    <>
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        >
          <div className="flex items-center justify-between p-5 border-b border-gray-200">
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-xl font-bold text-gray-900 break-words">{isEditing ? 'Редактирование черновика' : 'Новый запрос о помощи'}</h3>
                <p className="text-sm text-gray-500 break-words">{isEditing ? 'Измените данные и опубликуйте' : 'Заполните детали, и мы найдем вам помощника'}</p>
              </div>
            </div>
            <button onClick={onClose} className="text-gray-400 hover:text-gray-600 p-2 rounded-full flex-shrink-0 ml-4">
          ...
          <div className="flex flex-col-reverse md:flex-row justify-between items-center p-5 border-t border-gray-200 bg-gray-50 rounded-b-2xl gap-4">
              ...
              {isEditing && (
                <>
                  <button
                    ...
                    className="w-full md:w-auto px-4 py-2 text-sm font-medium text-indigo-700 bg-indigo-100 border border-transparent rounded-xl hover:bg-indigo-200 disabled:opacity-50 transition flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    disabled={isSubmitting}
                    className="w-full md:w-auto px-4 py-2 text-sm font-medium text-red-700 bg-red-100 border border-transparent rounded-xl hover:bg-red-200 disabled:opacity-50 transition flex items-center justify-center gap-2"
                  >
            ...
            <div className="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
              ...
              <button type="button" onClick={onClose} className="w-full md:w-auto px-4 py-2 text-sm font-medium text-gray-700 rounded-xl hover:bg-gray-100 transition text-center">
                Отмена
              </button>
              ...
              <button
                ...
                disabled={isSubmitting}
                className="w-full md:w-auto px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 transition flex items-center justify-center gap-2"
