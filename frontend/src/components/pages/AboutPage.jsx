    ...
    <div className="bg-white">
      ...
      <div className="relative bg-gradient-to-r from-primary-600 to-primary-800 py-16 sm:py-24">
        <div className="container-custom text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl animate-slideDown" style={{animationDelay: '0.1s'}}>О нас</h1>
          <p className="mt-6 max-w-3xl mx-auto text-xl text-primary-100 animate-slideUp" style={{animationDelay: '0.3s'}}>
      ...
      <div className="py-16 bg-gray-50">
        <div className="container-custom">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12 animate-slideDown" style={{animationDelay: '0.2s'}}>Наши ценности</h2>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm p-6 animate-slideUp hover:shadow-md transition-all duration-300" style={{animationDelay: '0.3s'}}>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 animate-slideUp hover:shadow-md transition-all duration-300" style={{animationDelay: '0.5s'}}>
              <div className="w-12 h-12 rounded-full bg-primary-100 flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 animate-slideUp hover:shadow-md transition-all duration-300" style={{animationDelay: '0.7s'}}>
              <div className="w-12 h-12 rounded-full bg-primary-100 flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="py-16 bg-primary-600">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bold text-white mb-6 animate-slideDown" style={{animationDelay: '0.2s'}}>Присоединяйтесь к нам!</h2>
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto animate-fadeIn" style={{animationDelay: '0.4s'}}>
