...
const RequestDetailPage = () => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'closed':
        return <span className="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-sm font-medium">Закрыта</span>;
      case 'cancelled':
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
        <div className="p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            {/* Кнопки для автора запроса (можно добавить проверку на текущего пользователя) */}
            {/* 
            <button 
