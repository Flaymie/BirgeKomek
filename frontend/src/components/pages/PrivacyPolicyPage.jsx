    ...
    <div className="bg-white">
      ...
      <div className="relative bg-gradient-to-r from-primary-600 to-primary-800 py-16 sm:py-24">
        <div className="container-custom text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl" >Политика конфиденциальности</h1>
      ...
      <div className="py-16 bg-white">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4" >3. Как мы используем вашу информацию</h2>
            <p className="text-lg text-gray-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4" >4. Раскрытие информации</h2>
            <p className="text-lg text-gray-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4" >6. Права пользователей</h2>
            <p className="text-lg text-gray-600 mb-4">
              Вы имеете право:
            </p>
            <ul className="list-disc pl-6 mb-6 text-lg text-gray-600">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4" >7. Изменения в Политике конфиденциальности</h2>
            <p className="text-lg text-gray-600 mb-6">
