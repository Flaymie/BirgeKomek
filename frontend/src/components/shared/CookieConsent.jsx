    ...
    return (
        <div className="cookie-consent-banner">
            <div className="cookie-consent-text">
                <p>Мы используем файлы cookie, чтобы сделать ваш опыт использования сайта лучше. Нажимая «Принять», вы соглашаетесь на использование всех наших файлов cookie. Ну или почти всех. <a href="/cookie-policy">Подробнее</a></p>
            </div>
