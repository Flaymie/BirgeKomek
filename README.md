...
# 1. Запустите в терминале: npx web-push generate-vapid-keys
# 2. Скопируйте полученные Public и Private ключи в файл .env
# 3. Public Key также понадобится для фронтенда (но он автоматически отдается через API)
```
